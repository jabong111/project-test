		...
		<table width="600" border="1" cellpadding="3" cellspacing="0"
			...
			<tr>
				...
				<td>
					...
					<input type="button" value="우편찾기" onclick="sample3_execDaumPostcode()"><!-- 버튼누르면 새로운창이 떠야된다. 주소를 검색하는 새로운창 zipCheck 자바스크립트 함수를 실행하고 자바스크립트 함수는 ZipCheck.jsp파일을 열게하는 함수이다.-->
					우편번호를 검색하세요					
				</td>
			</tr>
			<tr>
