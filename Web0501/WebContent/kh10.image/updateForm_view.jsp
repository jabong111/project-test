		...
		<table width="100%" border="1" cellpadding="1" cellspacing="0">
			...
			<tr>
				...
				<td><input type="text" name="email" size="10"
					value="${theme.email }"></td>
			</tr>
			<tr>
				<td>암호</td>
				<td><input type="password" name="password" size="10" vlaue=""></td>
			</tr>
			<tr>
				<td>이미지</td>
				<td><input type="file" name="imageFile"> 
					<c:if test="${!empty theme.image }">
						<br>
						<img src="/Web0426/image/${theme.image }" width="150" border="0">
					</c:if>
				</td>
			</tr>
			<tr>
				<td>내용</td>
				<td><textarea name="content" cols="40" rows="8">${theme.content}</textarea>
				</td>
			</tr>
			<tr>
