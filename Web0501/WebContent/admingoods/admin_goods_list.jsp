...
<%
	Collection list = (Collection) request.getAttribute("list");	//영역에 저장된 리스트를 객체로 만든다.
	Object obj[] = list.toArray();	//물품 리스트객첼ㄹ 만든다. 객체 배열로 만든다.
	GoodsBean agb = null;
%>
	...
	<tr>
		...
		<table border="0" width="80%">
			...
			<a href="javascript:goodsdelete(<%=agb.getGOODS_NUM()%>);">
				<font size=2>삭제</font><!-- 삭제 액션으로 보낸다 -->
			</a>
			</p>
			</td>
			</tr>
